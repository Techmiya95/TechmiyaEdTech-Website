...
export const metadata: Metadata = {
  title: "Best IT Training Institute in Jayanagar Bangalore | 100% Placement | Techmiya EdTech",
  ...
  alternates: {
    canonical: "https://www.techmiyaedtech.com/",
  },
  openGraph: {
    title: "Best IT Training Institute in Jayanagar Bangalore | 100% Placement | Techmiya EdTech",
    description: "Techmiya EdTech—#1 IT training institute in Jayanagar, Bangalore. Best courses in AI, Data Science & Full Stack development. 100% placement. Enroll today!",
    ...
    <div className="min-h-screen">
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([homepageSchema, organizationSchema, localBusinessSchema, faqSchema]),
        }}
      />
      {/* Hero Section */}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Link href="/services/workshops" className="bg-gradient-to-br from-indigo-50 to-blue-50 p-6 rounded-2xl hover:shadow-lg transition-shadow cursor-pointer border border-blue-100">
            ...
            <Link href="/services/corporate-training" className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-2xl hover:shadow-lg transition-shadow cursor-pointer">
              <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mb-4">
                <span className="text-2xl">🏢</span>
              </div>
            ...
            <Link href="/services/csr-programs" className="bg-gradient-to-br from-green-50 to-teal-50 p-6 rounded-2xl hover:shadow-lg transition-shadow cursor-pointer">
            ...
            <Link href="/services/partnerships" className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-2xl hover:shadow-lg transition-shadow cursor-pointer">
            ...
            <Link href="/services/campus-drives" className="bg-gradient-to-br from-orange-50 to-amber-50 p-6 rounded-2xl hover:shadow-lg transition-shadow cursor-pointer">
            ...
            <Link href="/services/hackathons" className="bg-gradient-to-br from-red-50 to-rose-50 p-6 rounded-2xl hover:shadow-lg transition-shadow cursor-pointer">
            ...
            <Link href="/services/fdp-sdp" className="bg-gradient-to-br from-cyan-50 to-sky-50 p-6 rounded-2xl hover:shadow-lg transition-shadow cursor-pointer">
            ...
            <Link href="/services/internships" className="bg-gradient-to-br from-yellow-50 to-lime-50 p-6 rounded-2xl hover:shadow-lg transition-shadow cursor-pointer">
            ...
            <Link href="/services/mentorship" className="bg-gradient-to-br from-indigo-50 to-violet-50 p-6 rounded-2xl hover:shadow-lg transition-shadow cursor-pointer">
