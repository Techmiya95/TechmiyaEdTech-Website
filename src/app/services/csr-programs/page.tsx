...
export const metadata: Metadata = {
  title: "CSR Programs - Techmiya EdTech",
  description: "Skill development initiatives aligned with Corporate Social Responsibility goals. Partner with Techmiya EdTech for social impact.",
  alternates: {
    canonical: "https://www.techmiyaedtech.com/services/csr-programs",
  },
  openGraph: {
    title: "CSR Programs - Techmiya EdTech",
    description: "Skill development initiatives aligned with Corporate Social Responsibility goals. Partner with Techmiya EdTech for social impact.",
    url: "https://www.techmiyaedtech.com/services/csr-programs",
    type: "website",
  },
};
