  ...
  return (
    <div className="min-h-screen bg-slate-50 py-20">
      ...
      <article className="container max-w-4xl px-4 mx-auto">
        <Link href="/blog" className="inline-flex items-center text-blue-600 hover:text-blue-800 mb-8 font-semibold">
        ...
        <div className="prose prose-lg prose-blue max-w-none text-slate-700">
          ...
          <div className="bg-blue-50 p-8 rounded-2xl border border-blue-100 my-10">
            ...
            <p className="mb-0">
              Techmiya EdTech in Jayanagar offers a comprehensive, offline <Link href="/courses/devops-training-jayanagar" className="font-bold text-blue-700 hover:underline">DevOps Training Program</Link>. You'll learn on actual AWS infrastructure, build a real CI/CD pipeline, and get 100% placement assistance.
            </p>
          </div>
        </div>
      </article>
